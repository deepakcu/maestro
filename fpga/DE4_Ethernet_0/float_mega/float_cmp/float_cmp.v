...
//altfp_compare CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Stratix IV" PIPELINE=1 WIDTH_EXP=8 WIDTH_MAN=23 ageb aleb clk_en clock dataa datab
...
endmodule //float_cmp_altfp_compare_5ac
//VALID FILE
...
module float_cmp (
	...
	float_cmp_altfp_compare_5ac	float_cmp_altfp_compare_5ac_component (
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
