...
//altfp_mult CBX_AUTO_BLACKBOX="ALL" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Stratix IV" EXCEPTION_HANDLING="NO" PIPELINE=5 REDUCED_FUNCTIONALITY="NO" ROUNDING="TO_NEAREST" WIDTH_EXP=8 WIDTH_MAN=23 clock dataa datab overflow result
...
endmodule //float_mult_altfp_mult_elo
//VALID FILE
...
module float_mult (
	...
	float_mult_altfp_mult_elo	float_mult_altfp_mult_elo_component (
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
				.overflow (sub_wire0),
